...
const ProductList = () => {
  ...
  const actionColumn = (cell, row, rowIndex, formatExtraData) => {
    return (
      <>
      <button className='btn btn-primary btn-sm me-2' onClick={() => editItem(row)}>Edit</button>
       <button className='btn btn-danger btn-sm'  onClick={() => deleteItem(row)}>Delete</button>
      </>
    );
  };
                              ...
                              <div>
                                <SearchBar { ...props.searchProps } srText='' />
                                {
                                  showBtnRemoveAllData && (
                                    <button type='button' className='btn btn-danger' onClick={removeAllRows}>Remove All</button>
                                  )
                                }
                                <hr />
                                ...
                                cellEdit={cellEditFactory({
                                  ...
                                  afterSaveCell:(oldValue, newValue, row, column) => {
                                    ...
                                    console.log('afterSaveCell 1111=====>', row, column)
                                    // const modeifyArr = productsArr.filter((u) =>{
                                    //   const matchObj = JSON.stringify(row) === JSON.stringify(u);
                                    //   console.log('afterSaveCell 1111=====>', matchObj)
                                    //   if(matchObj){
                                    //     // const mergeArr = [...productsArr];
                                    //     console.log('afterSaveCell 22222=====>', u) 
                                    //     return u;
                                    //   }
                                    //   return null
                                    // })
                                    // const mergeArr = [...productsArr, ...modeifyArr];
                                    // setProductsArr(
                                    //   productsArr.map((pr) => {
                                    //     return Object.assign({}, modeifyArr)
                                    //   })
                                    // )
